...
const AddIncomeInstance = ({ setOpenAddIncome, setIncomeInstance, getIncomeList }) => {
      ...
      <div>
        <Container fluid className="main_content_container mx-auto">
          <div className="d-flex justify-content-between align-items-center mb-2">
            <h3 className="main_content_heading">Add Income</h3>
            <CrossButton
              onClick={() => setOpenAddIncome((o) => !o)}
            ></CrossButton>
          </div>
          <Form
            noValidate
            validated={validated}
            onSubmit={addIncomeFormHandler}
          ...
          >
            <Stack gap={1}>
              ...
              <Row className="pt-9 mb-1 justify-content-end">
                <Col sm="auto">
                  <GeneralButton
                    onClickEvent={() => setOpenAddIncome((o) => !o)}
                    className="me-1"
                    value="Cancel"
                    color="#505050"
                    variant="outlined"
...
export default AddIncomeInstance;
